...
const TabelaArrecadacao = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    const url = `http://52.2.29.147:8080/revenue/findByRange?startYear=${rangeAnoMes.startYear}&endYear=${rangeAnoMes.endYear}&startMonth=${rangeAnoMes.startMonth}&endMonth=${rangeAnoMes.endMonth}&orderBy=${orderBy}`;
    console.log('URL:', url);
