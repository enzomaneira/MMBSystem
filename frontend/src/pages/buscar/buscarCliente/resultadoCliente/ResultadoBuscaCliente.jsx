  ...
  const handleReturnAll = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setError("Erro ao retornar todos os clientes: " + response.statusText);
      }
    } catch (error) {
      setError("Erro ao retornar todos os clientes: " + error.message);
    }
  };
    ...
    <div>
      ...
      <Container>
        <div className={styles.clientContainer}>
          ...
          <button onClick={handleReturnAll}>Retornar todos</button>
          ...
          {clientes.map((cliente) => (
            <div key={cliente.id} className={styles.clientItem}>
              ...
              <p>Valor Gasto: {cliente.countMoney}</p>
            </div>
          ))}
        </div>
      </Container>
